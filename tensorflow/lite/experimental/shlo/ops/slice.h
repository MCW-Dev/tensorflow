...
#ifndef TENSORFLOW_LITE_EXPERIMENTAL_SHLO_OPS_SLICE_H_
#define TENSORFLOW_LITE_EXPERIMENTAL_SHLO_OPS_SLICE_H_
...
#endif  // TENSORFLOW_LITE_EXPERIMENTAL_SHLO_OPS_SLICE_H_