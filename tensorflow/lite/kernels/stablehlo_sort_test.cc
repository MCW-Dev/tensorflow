 ...
 public:
  SortOpModel(const std::vector<TensorData>& inputs,
    ...
    SetBuiltinOp(BuiltinOperator_STABLEHLO_SORT,
                 ...
                 CreateStablehloSortOptions(builder_, params.dimension,
                                            params.is_stable, 1)
                     .Union());
    ...
    subgraph_builder_.BuildComparatorSubgraph(interpreter_->subgraph(1),
                                              comparison_direction, num_inputs,
                                              lhs, rhs, type);
