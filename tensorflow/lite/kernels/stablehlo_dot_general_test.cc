...
template <>
void StablehloDotGeneralOpModel::SetInputs<tensorflow::bfloat16>(
    std::initializer_list<tensorflow::bfloat16> data_lhs,
    std::initializer_list<tensorflow::bfloat16> data_rhs) {
  PopulateTensor<tensorflow::bfloat16>(lhs_, data_lhs);
  PopulateTensor<tensorflow::bfloat16>(rhs_, data_rhs);
}
...
TEST(StablehloDotGeneralModelTest, F32TestWorks1) {
  ...
  StablehloDotGeneralOpModel model({TensorType_FLOAT32, {2, 2, 2}},
                                   ...
                                   {TensorType_FLOAT32, {2, 2, 2}}, params);
  model.SetInputs<float>({1.1, 2.2, 3.3, 4.3, 5.5, 6, 7, 8},
...
TEST(StablehloDotGeneralModelTest, F16TestWorks1) {
  ...
  StablehloDotGeneralOpModel model({TensorType_FLOAT16, {2, 2, 2}},
                                   ...
                                   {TensorType_FLOAT16, {2, 2, 2}}, params);
...
TEST(StablehloDotGeneralModelTest, BFloat16Works1) {
  ...
  StablehloDotGeneralOpModel model({TensorType_BFLOAT16, {2, 2, 2}},
                                   ...
                                   {TensorType_BFLOAT16, {2, 2, 2}}, params);
  std::initializer_list<tensorflow::bfloat16> lhs_data{
      tensorflow::bfloat16(1.1), tensorflow::bfloat16(2.2),
      tensorflow::bfloat16(3.3), tensorflow::bfloat16(4.3),
      tensorflow::bfloat16(5.5), tensorflow::bfloat16(6.0),
      tensorflow::bfloat16(7.0), tensorflow::bfloat16(8.0)};
  std::initializer_list<tensorflow::bfloat16> rhs_data{
      tensorflow::bfloat16(1.2), tensorflow::bfloat16(0.0),
      tensorflow::bfloat16(0.0), tensorflow::bfloat16(1.2),
      tensorflow::bfloat16(1.2), tensorflow::bfloat16(0.0),
      tensorflow::bfloat16(0.0), tensorflow::bfloat16(1.2)};
  model.SetInputs<tensorflow::bfloat16>(lhs_data, rhs_data);

  ASSERT_EQ(model.Invoke(), kTfLiteOk);

  std::initializer_list<tensorflow::bfloat16> expected_values = {
      tensorflow::bfloat16(1.32813), tensorflow::bfloat16(2.6562),
      tensorflow::bfloat16(3.96875), tensorflow::bfloat16(5.1875),
      tensorflow::bfloat16(6.6250),  tensorflow::bfloat16(7.21875),
      tensorflow::bfloat16(8.4375),  tensorflow::bfloat16(9.6250)};
