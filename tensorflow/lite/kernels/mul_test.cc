...
TEST(MulOpTest, NoActivationFloatInplaceInput016) {
...
TEST(MulOpTest, NoActivationFloatInplaceInput1f16) {
  FloatMulOpModel<Eigen::half> m({TensorType_FLOAT16, {1, 2, 2, 1}},
                    {TensorType_FLOAT16, {1, 2, 2, 1}},
                    {TensorType_FLOAT16, {}}, ActivationFunctionType_NONE,
                    {static_cast<Eigen::half>(-2.0), static_cast<Eigen::half>(0.2), static_cast<Eigen::half>(0.7), static_cast<Eigen::half>(0.8)}, {static_cast<Eigen::half>(0.1), static_cast<Eigen::half>(0.2), static_cast<Eigen::half>(0.3), static_cast<Eigen::half>(0.5)}, false);
...
TEST_P(MulOpTest, NoActivationFloatf16) {
  const bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatActivationRELU_N1_TO_1f16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatVariousInputShapesf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithScalarBroadcastf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithBroadcastf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatMixedBroadcastf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithBroadcast2Elementsf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatScalarAndOneElementf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST(MulOpTest, NoActivationFloatInplaceInput0b16) {
...
TEST(MulOpTest, NoActivationFloatInplaceInput1bf16) {
  FloatMulOpModel<Eigen::bfloat16> m({TensorType_BFLOAT16, {1, 2, 2, 1}},
                    {TensorType_BFLOAT16, {1, 2, 2, 1}},
                    {TensorType_BFLOAT16, {}}, ActivationFunctionType_NONE,
                    {static_cast<Eigen::bfloat16>(-2.0), static_cast<Eigen::bfloat16>(0.2), static_cast<Eigen::bfloat16>(0.7), static_cast<Eigen::bfloat16>(0.8)}, {static_cast<Eigen::bfloat16>(0.1), static_cast<Eigen::bfloat16>(0.2), static_cast<Eigen::bfloat16>(0.3), static_cast<Eigen::bfloat16>(0.5)}, false);
...
TEST_P(MulOpTest, NoActivationFloatbf16) {
  const bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatActivationRELU_N1_TO_1bf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatVariousInputShapesbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithScalarBroadcastbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithBroadcastbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatMixedBroadcastbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatWithBroadcast2Elementsbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
...
TEST_P(MulOpTest, FloatScalarAndOneElementbf16) {
  bool constant_tensors = GetParam();
  if (SingleOpModel::GetForceUseNnapi() && constant_tensors) {
    // NNAPI does not support graphs with all constant inputs.
    return;
